...
document.getElementById("Offers").addEventListener("click", () => {
    ...
    result.forEach((restaurant) => {
        ...
        offerInfo.innerHTML = `Offers: ${restaurant.offers}`;
        
        const card = getrestaurant(restaurant);
...
document.getElementById("Open").addEventListener("click", () => {
    ...
    result.forEach((restaurant) => {
        ...
        openInfo.innerHTML = `Open Time: ${restaurant.restaurant_open_time}`;
